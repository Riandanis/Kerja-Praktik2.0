            ...
            <div class="box">
                ...
                <div class="box-body">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal" method="post" action="{{url('agenda/store', $id)}}">
                                            {{ csrf_field() }}
                                            <div class="box-body">
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr>
                                <th style="width: 125px">ID Agenda</th>
                                <th>Agenda</th>
                                <th colspan="2"></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width:30px;">
                                    <button id="btn-edit" type="button" class="btn btn-default edit-button" data-toggle="modal" data-target="#modal-default" data-id="{{$a->id_agenda}}" data-rapat="{{$a->headline}}" data-name="{{$a->nama_agenda}}">
