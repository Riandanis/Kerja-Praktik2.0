...
//                    $('#insert-topik').append('<tr><td><strong>Topik</strong></td><td></td></tr>');
                    ...
                    data.forEach(function(obj){
                        ...
                        console.log(str);
                        $('#insert-topik').append('<tr><td width="500px">'+obj.nama_topik+'</td><td width="30px"><a href="/topik/edit/'+obj.id_topik+'"><button class="btn btn-default">Edit</button></a></td><td><a href="/topik/delete/'+obj.id_topik+'"><button class="btn btn-danger">Hapus</button></a></td></tr>');
                    });
                }
            })
